...
<br>
　(4)ワード検索(※実装済み)やタグ検索(※未実装)により、他ユーザーの投稿したリストやアイテムを表示する。  
...
### 2-1-4. ユーザー情報の表示、各ユーザーの最新リストタイトルの表示
...
### 2-1-5. キーワード検索：リスト・アイテムの表示
　(1)トップページ(＝リスト一覧ページ)で、キーワード検索をクリックする。  
　(2)検索ワードを入力する。ワード同士をスペースで区切ると、複数のワードで検索できる。部分一致検索。  
...
<br>
/search  
![画像：2-1-5(1)feature](app/assets/images/readme/2-1-5(1)feature.png)
<br>
<br>
/search  
![画像：2-1-5(2)feature](app/assets/images/readme/2-1-5(2)feature.png)
<br>
<br>
<br>
