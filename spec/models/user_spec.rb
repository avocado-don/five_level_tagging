...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録できない場合' do
      ...
      it 'password と password_confirmation の大文字と小文字が不一致では登録できない' do
      ...
      it 'contact が101文字以上では登録できない' do
      ...
      it 'profile が201文字以上では登録できない' do
